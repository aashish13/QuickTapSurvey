...
<section id="container" >
        <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="/QuickTap/" class="logo"><b>Capstone</b></a>
            <!--logo end-->
                <div class="top-menu">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href=""><img src="${pageContext.request.contextPath}/img/pc.png"  class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      <a href="/QuickTap/survey" >
                          <i class="fa fa-desktop"></i>
                          <span>Surveys</span>
                      </a> </li>

                  <li class="sub-menu">
                      <a href="/QuickTap/response" >
                            <i class=" fa fa-bar-chart-o"></i>Responses</a>
                       </li>
                 </ul>
              <!-- sidebar menu end-->
          </div>
