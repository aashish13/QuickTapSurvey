...
<body data-spy="scroll" data-target=".navbar-fixed-top">
	...
	<section id="main-content">
		<section class="wrapper">
			...
			<form:select path="questions" id="question-1">
				<form:option value="-- Select a question --"></form:option>>
 					<form:options items="${questions}" />
			</form:select>
			
			<form:select path="questions" id="question-2">
				<form:option value="-- Select a question --"></form:option>>
 					<form:options items="${questions}" />
			</form:select>
			<br/>
			<br/>
			<!-- page start-->
			<input type="button" value="  Generate CrossTabulation  " id="generate-crosstabulation"></input>
			<div
				...
				<div id="cross-tab" style="height: 500px; width: 800px;">
			</div>
			<!-- page end-->
		</section>
	</section>
	<jsp:include page="footer.jsp" />
	<script src="${pageContext.request.contextPath}/js/crosstabulation.js" type="text/javascript"></script>
