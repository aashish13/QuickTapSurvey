			...
			data-original-title="Toggle Navigation"></div>
                 	...
                 	<nav class="collapse navbar-collapse navigation" id="bs-example-navbar-collapse-1" role="navigation">
                        <ul class="nav navbar-nav navbar-right ">
                            ...
                            <li><a href="https://www.quicktapsurvey.com/public/signup/?sourcePage=organic-home&rt=fbt" class="page-scroll" style="font-size:15px;font-weight:bolder;">User</a> </li>
                        </ul>
                     </nav>
                </div><!-- /.container-fluid -->
</header>
				...
				<div class="col-md-12 mt">
					<div class="content-panel">
						<table class="table table-hover">
							<h4>
								<i class="fa fa-angle-right"></i> Survey List <form method="get" action="syncsurvey" style="
    float:right;">
				<button type="submit" class="btn btn-round btn-primary" style="
    width: 95px;
    margin-left: 840px;
">
				...
				<ul class="dropdown-menu" style="background-color: #294D6D;text-align:center;min-width: 80px;border-color: black;margin: 0 -10px -130px 0;border: 1px solid rgba(0,0,0,.15);box-shadow: 0 6px 12px rgb(75, 70, 93);">


													<li><a style="color:white;" href="response?id=${survey.id}">Responses</a></li>

													<!-- <li><a href="response">Responses</a></li> -->
                                                    
													<li><a style="color:white" href="#">Sync Now</a></li>
													<li><a style="color:white" href="charts">Report</a></li>
												</ul>
																						</div>
										 </td>
